...
public final class ABCDGuesser1 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * nests 4 while loops to use every possible iteration of the exponents
         * for each of the user-inputted numbers. inside of the final while
         * loop, finds the difference from the estimation and the old value
         * 'change.' if the new estimation is closer to the true value, it
         * replaces the old value, which gives the best value after the while
         * loops are finished. the variables for the exponents are also updated
         * if the new value is a better estimation. while loops are updated
         * using (variable)++ and resetting a variable to 0 after its loop is
         * done.
         */
        while (d <= numExponents) {
            while (c <= numExponents) {
                while (b <= numExponents) {
                    while (a <= numExponents) {
